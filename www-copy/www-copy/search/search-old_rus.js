    ...
    if ( no_words == 0 ) {
      ...
      if ( settings.lfName ) {
        ...
        innercode +=
          ...
          language.lexicalFunction + ' <input type="text" id="' + get_id(block, "lf_func") + id + '" name="lf_func' + id + '" value="' + settings.defaultType + '" class="text" size="60" /> ' +
        ...
        innercode += '&nbsp;&nbsp; ' + language.lexicalFunctionPrep  + ': <input type="text" id="' + get_id(block, "lf_prep") + id + '" name="lf_prep' + id + '" value="' + settings.defaultType + '" class="text" size="30" /> '
          '</td></tr>';
      }
      innercode += '</table>';
    }
    ...
    innercode +=
        ...
        '</tr><tr>' +
          '<td class="wordreqinput" style="z-index:' + zind + '">' +
           '<div attr="suggest" style="position:relative;z-index:' + zind + '">' +
            '<input type="text" autocomplete="off" id="' + get_id(block, "lex") + id + '" name="lex' + id + '" class="text100" style="z-index:' + zind + ';font-family:BukyVede">' +
    ...
    if (settings.zoneName) {
      innercode +=
        '<tr>'+
          ...
          '</td>'+
          '<td class="wordreqinput">'+
            '<input type="text" id="' + get_id(block, "zone") + id + '" name="zone' + id + '" class="text100">'+
          '</td>';
      innercode += '</tr>';
    }
...
function expandAccent(s) {
  if (s == parseInt(s)) {
    var res = 'пїЅ' + s + ' | пїЅ' + s + ' | пїЅ' + s + ' | пїЅ' + s + ' | пїЅ' + s + ' | пїЅ' + s + ' | пїЅ' + s + ' | пїЅ' + s;
    return res;
  }
