var settings = {
  ...
  addSonImage : '<span class="glyphicon glyphicon-circle-arrow-down" aria-hidden="true" title="' + language.addSibling + '" alt="' + language.addSibling + '"></span>',
...
function draw_word ( block, id, parentid, level ) {
  ...
  if (block == 0) {
    if ( no_words == 0 ) {
      innercode +=
          '<div class="col-xs-3"><div class="form-group distreq">' +
    ...
    innercode +=
      '<div class="well"><div class="row"><table class="wordreq" width="100%">' +
        '<tr valign="bottom">' +
          '<td class="' + widthSettings + '">' +
            language.word + ' ' +
            ' <a href="help-lexic-word.html" onClick="return showhelp(\'help-lexic-word.html\',516)">' + settings.helpImage + '</a>'+
            ' <a href="#" onClick="return getVkb(\'lex' + id + '\' )"><img style="vertical-align:bottom;" src="static/img/keyboard.gif" alt="Virtual keyboard" title="Virtual keyboard" width="42" height="21" border="0"></a>' +
          '</td>' +
          '<td class="' + widthSettings + '">' +
